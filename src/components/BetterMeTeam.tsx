						...
						<div className="relative h-full">
							...
							{current.chat.top && (
								<AnimatePresence mode="wait">
									<motion.div
										...
										className="absolute right-12 md:right-16 top-[60%] max-w-sm rounded-2xl px-5 py-4 text-sm bg-[#3498DB] text-white shadow-xl">
											{current.chat.top}
							...
							<AnimatePresence mode="wait">
								<motion.div
									...
									className="absolute left-8 md:left-12 bottom-[14%] max-w-md rounded-2xl px-5 py-4 text-sm bg-white text-dark shadow-xl">
										{current.chat.bottom}
