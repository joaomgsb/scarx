    ...
    extend: {
      colors: {
        ...
        dark: {
          ...
          lighter: '#1A1A1A', // Cinza muito escuro
          accent: '#2A2A2A',  // Cinza escuro para cards
        },
        light: {
          DEFAULT: '#FFFFFF', // Branco puro
          gray: '#F8F9FA',    // Cinza muito claro
      ...
      animation: {
        ...
        'particle-left': 'particleLeft 4s linear infinite',
        'particle-right': 'particleRight 4s linear infinite',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
